...
root.title("Medicinal Plant and disease Prediction")

#####For background Image
#loading the images
img=ImageTk.PhotoImage(Image.open("p1.jpeg"))

img2=ImageTk.PhotoImage(Image.open("p2.jpg"))

img3=ImageTk.PhotoImage(Image.open("p3.jpg"))
...
text_var="Medicinal plant detection"
...
#    global fn
    ...
    if fn!="":
        ...
        model = load_model(r'D:/ashwini bitmap folder 2023/23c9348 Medicinal Plant plus disease Prediction/medicinal plant/medicinal plant/model1..h5py')
        ...
        if Nutrient == 0:
            Cd="Aloevera \n fresh gel, juice and other formulations \n for health, medicinal and cosmetic purpose."
        elif Nutrient == 1:
            Cd="Amla \n powder, syrups and oils, dried and treated \n slices, crushed and pasty form (as in Chawanprash)."
        elif Nutrient == 2:
           Cd="Betel \n quids, a mixture of tobacco, powdered or \n sliced betel nut, and other ingredients."
        elif Nutrient == 3:
            Cd="Curry_Leaf \n A Grade Dried Curry Leaves \n Organic Curry Leaves Powder Curry Leaf "
        elif Nutrient == 4:
            Cd="Nagadali \n cultivated as a medicinal herb, as a condiment,\n  and to a lesser extent as an insect repellent."
        elif Nutrient == 5:
            Cd="Raktachandini \n Raktachandan's Raw Herb , Raktachandan's Oil,  \n  Raktachandan's Powder."
        elif Nutrient == 6:
            Cd="Wood_sorel \n high vitamin C content , cooking medicinal purposes"
